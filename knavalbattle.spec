...
Version  : 19.04.2
Release  : 8
URL      : https://download.kde.org/stable/applications/19.04.2/src/knavalbattle-19.04.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.2/src/knavalbattle-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/knavalbattle-19.04.2.tar.xz.sig
...
%prep
%setup -q -n knavalbattle-19.04.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1559896046
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
