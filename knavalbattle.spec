...
Source0  : https://download.kde.org/stable/applications/19.04.0/src/knavalbattle-19.04.0.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.0/src/knavalbattle-19.04.0.tar.xz.sig
...
%prep
%setup -q -n knavalbattle-19.04.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1557024666
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
