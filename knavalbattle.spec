...
Version  : 19.08.2
Release  : 12
URL      : https://download.kde.org/stable/applications/19.08.2/src/knavalbattle-19.08.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.2/src/knavalbattle-19.08.2.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.2/src/knavalbattle-19.08.2.tar.xz.sig
...
%prep
%setup -q -n knavalbattle-19.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570749563
mkdir -p clr-build
pushd clr-build
