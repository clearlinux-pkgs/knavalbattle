...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/knavalbattle-21.12.0.tar.xz
...
%prep
%setup -q -n knavalbattle-21.12.0
cd %{_builddir}/knavalbattle-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639621796
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knavalbattle-21.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/knavalbattle/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/knavalbattle-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/knavalbattle/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
