...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/knavalbattle-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/knavalbattle-22.04.2.tar.xz.sig
...
%prep
%setup -q -n knavalbattle-22.04.2
cd %{_builddir}/knavalbattle-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654833006
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knavalbattle-22.04.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/knavalbattle/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/knavalbattle-22.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/knavalbattle/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/knavalbattle-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/knavalbattle/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/knavalbattle-22.04.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/knavalbattle/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/knavalbattle-22.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/knavalbattle/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
