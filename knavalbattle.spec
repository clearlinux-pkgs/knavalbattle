...
Version  : 24.08.0
Release  : 69
URL      : https://download.kde.org/stable/release-service/24.08.0/src/knavalbattle-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/knavalbattle-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/knavalbattle-24.08.0.tar.xz.sig
...
%setup -q -n knavalbattle-24.08.0
cd %{_builddir}/knavalbattle-24.08.0
pushd ..
cp -a knavalbattle-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724518107
mkdir -p clr-build
pushd clr-build
